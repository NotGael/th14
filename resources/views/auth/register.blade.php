                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('section_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="section_id" type="text" class="form-control" name="section_id" value="{{ old('section_id') }}">
                        ...
                        <div class="form-group{{ $errors->has('address_id') ? ' has-error' : '' }}">
                            <label for="address_id" class="col-md-4 control-label">Address</label>

                            <div class="col-md-6">
                                <input id="address_id" type="text" class="form-control" name="address_id" value="{{ old('address_id') }}">
